    ...
    function u(e, t) {
      for (var n = {}, r = [], o = 0; o < e.length; o++) {
        ...
        -1 !== f
          ...
          : a.push({ identifier: c, updater: v(p, t), references: 1 }),
          r.push(c);
      }
      return r;
    }
     ...
     */ !(function (t, n) {
      ...
      function Te(e, t, n, r, o) {
        ...
        for (f.textContent = "", d = 0; (i = p[d++]); )
          if (r && C.inArray(i, r) > -1) o && o.push(i);
            ...
            ((l = ae(i)), (a = xe(f.appendChild(i), "script")), l && be(a), n)
          )
      ...
      function Re(e, t) {
        ...
        if (1 === t.nodeType) {
          ...
          K.hasData(e) &&
            ((i = K.access(e)), (a = C.extend({}, i)), K.set(t, a));
        }
      }
      function Ie(e, t) {
        var n = t.nodeName.toLowerCase();
      ...
      function We(e, t, n, r) {
        ...
        if (
          ...
          for (s = (a = C.map(xe(o, "script"), Pe)).length; f < p; f++)
            (l = o),
              f !== d &&
      ...
      function nt(e, t, n, r, o, i) {
        ...
        for (; a < 4; a += 2)
          "margin" === n && (u += C.css(e, n + oe[a], !0, o)),
            r
              ? ("content" === n && (u -= C.css(e, "padding" + oe[a], !0, o)),
                "margin" !== n &&
                  (u -= C.css(e, "border" + oe[a] + "Width", !0, o)))
              : ((u += C.css(e, "padding" + oe[a], !0, o)),
                "padding" !== n
                  ? (u += C.css(e, "border" + oe[a] + "Width", !0, o))
                  : (s += C.css(e, "border" + oe[a] + "Width", !0, o)));
        return (
          !r &&
            i >= 0 &&
            (u +=
      ...
      C.ajaxSetup({
        ...
        C.each(["top", "left"], function (e, t) {
          C.cssHooks[t] = Xe(v.pixelPosition, function (e, n) {
            if (n)
              return (n = ze(e, t)), Be.test(n) ? C(e).position()[t] + "px" : n;
          });
        }),
